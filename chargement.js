...
function blip(nomsection)//fonction attribut dans les balises a 
{
    ...
    let gettexte = document.getElementById('texte');
...
function modal(nombre)//Affiche l'autre modal  
{
